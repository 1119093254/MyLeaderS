...
public class ImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_pager.setText(String.format(getString(R.string.select), currentItem + 1, imageInfo.size()));
        if(imageInfo.get(0).getWorkId().equals("")){
            CLog.e("imageInfo","imageInfo为空");
        }else {
            CLog.e("imageInfo",imageInfo.get(0).getWorkId());
            AddLookNum(imageInfo.get(0).getWorkId());
        }
    }
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            if (Json_Utils.getCode(response) == 0) {
                                ...
                                mSaveSharedPreferences.Save_PREFS(ImagePreviewActivity.this,"WorkIdNum",workid);
                            }
