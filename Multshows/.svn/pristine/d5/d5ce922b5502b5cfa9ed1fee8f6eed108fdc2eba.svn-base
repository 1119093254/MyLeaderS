...
public abstract class PlatformPage extends OnekeySharePage {
	...
	//	activity.getWindow().setBackgroundDrawable(new ColorDrawable(activity.getResources().getColor(com.multshows.R.color.background_alight)));
