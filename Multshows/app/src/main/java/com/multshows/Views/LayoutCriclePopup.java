...
/**
 * 功能描述：圈子评论上的的弹窗（继承自PopupWindow）
 */
public class LayoutCriclePopup extends PopupWindow {
    private static final String TAG = LayoutCriclePopup.class.getSimpleName();
    TextView likeText;
    ImageView likeimage;
    private RelativeLayout likeTextLayout;//赞
    private RelativeLayout commentLayout;//评论布局
    private RelativeLayout ShareLayout;//分享布局
...
//	private int popupGravity = Gravity.NO_GRAVITY;
    ...
    public LayoutCriclePopup(Context context) {
        // 设置布局的参数
        this(context, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    }

    public LayoutCriclePopup(Context context, int width, int height) {
...
//		mScreenHeight = Util.getScreenHeight(mContext);
        ...
        // 设置弹窗的布局界面
        View view = LayoutInflater.from(mContext).inflate(R.layout.popupcriclelayout, null);
        setContentView(view);
        ...
        ShareLayout.setOnClickListener(onclick);
    }
