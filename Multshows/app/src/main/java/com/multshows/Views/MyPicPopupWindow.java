 ...
 * 时间：2016.7.15
 */
public class MyPicPopupWindow extends PopupWindow {
    ...
    TextView mTextView;
    public MyPicPopupWindow(Activity context, final View.OnClickListener itemsOnClick,
                             String top,String center,String bottom,String position) {
        super(context);
        mContext=context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.photo_look_dialog, null);
      ...
      //  manageUtils.setSystemBarTintManage(context,R.color.black_alight_2);
        ...
        btn_Top = (Button) mMenuView.findViewById(R.id.lookPhoto_dialog_Top);
        btn_Center = (Button) mMenuView.findViewById(R.id.lookPhoto_dialog_Center);
        btn_Bottom = (Button) mMenuView.findViewById(R.id.lookPhoto_dialog_Bottom);
        mTextView= (TextView) mMenuView.findViewById(R.id.lookPhoto_dialog_text);
        btn_Top.setText(top);
        btn_Center.setText(center);
        btn_Bottom.setText(bottom);
        if("show".equals(position)){
