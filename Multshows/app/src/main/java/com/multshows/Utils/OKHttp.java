...
///////////////////////////////////////////////////////////////////////////
    ...
    public static void OkHttpPost(String url, String key, String json, StringCallback callback) {
            OkHttpUtils.post()
                    ...
                    .url("http://192.168.189.2:8080/MyLeaderS/servlet/LeaderServlet"+url)//http://api.leadershows.com/api
                    .addParams(key,json)
                    .build()
                    .connTimeOut(20000)
                    .readTimeOut(20000)
    ...
    public static void OkHttpPost1(String url, String key, String json, StringCallback callback) {
        OkHttpUtils.post()
                .url("http://api.mshow.test.viigoo.com:3311/api"+url)//http://api.leadershows.com/api
                //.url("http://192.168.189.2:8080/MyLeaderS/servlet/LeaderServlet"+url)//http://api.leadershows.com/api
                .addParams(key,json)
