...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mButton.setText(millisUntilFinished / 1000 + "秒可重发");  //设置倒计时时间
        mButton.setBackgroundResource(R.drawable.shape_grey_2); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        ...
        mButton.setBackgroundResource(R.drawable.shape_alight_green_2);  //还原背景色
    }
}
