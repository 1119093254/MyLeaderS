...
public class BoundBankList2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manageUtils.setSystemBarTintManage(BoundBankList2_Activity.this,R.color.app_topColor);
    ...
    private void initView() {
        ...
        momORBabyUtils.isMomORBaby(BoundBankList2_Activity.this,mReturnLayout,mParentLayout,mReturn,mTopTitle);
    }
    ...
    private void initData() {
        mBankListAdapter=new BoundBankList_Adapter(BoundBankList2_Activity.this,mList);
    ...
    private void initListen() {
        ...
        mAddBank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(BoundBankList2_Activity.this,Add_BankCord_Activity.class);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                EventBus.getDefault().post(new BankEvent_Model(mList.get(position),"bank"));
                finish();
            }
        });
    }
